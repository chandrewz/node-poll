...
app.get('/polls', function(request, response) { PollController.getAllPolls(request, response); });
app.get('/api/polls', function(request, response) { PollController.getAllPolls(request, response, true); });
